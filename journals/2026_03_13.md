...
- [x] problème de [hierarchy] :
	- [x] on devrait mettre l'AnimPlayer principal d'un [[Capable]] sur un **enfant** du capable pour en faire un réel component au lieu de l'avoir directement sur soi-même

- [x] problème [visuel] :
	- [x] quand un dev dynamiquement construit prend des dégats ça le flip pas correctement, faudrait faire qu'AnimPlayer aie une variable **flip** qui gèrerait le flip globalement comme ça les layers pourraient flip tt seul et on aurait meme pas besoin de passer par AnimPlayer.Renderer.flipX = machin