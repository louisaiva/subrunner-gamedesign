...
- ## **TODO**
	...
	- [ ] doit pouvoir gérer les movables loaded qui sortent des **Room** loaded
		...
		- [ ] faire que 2 [Room] voisines aient une frontière délimitée par un [EdgeCollider2D] qui s'active lorsque l'une des deux rooms est loadé et l'autre non ET que y'a pas de door fermée entre les deux.
